...
namespace CapaDatos.Repositorio.EF6
{
    public class Repository<TEntity> : IRepositoryAsync<TEntity> where TEntity : class, IObjectState
    {
        ...
        public TEntity GetSingle(Expression<Func<TEntity, bool>> query)
        {
        ...
        public virtual DataSet SelectQuerySentence(string query)
        {
            var cadena = ((System.Data.Entity.DbContext) (_context)).Database.Connection.ConnectionString;
